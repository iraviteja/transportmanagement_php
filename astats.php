  ...
  <div id="topbar">
     <div id="topnav">
      <ul>
        ...
        <li  ><a href="admin.php">Manage Ac/s</a></li>
        <li ><a href="afeedback.php">Feedback</a></li>
        <li class="active"><a href="astats.php">Stats</a></li>
...
<div class="content">
	...
	<center><h1><font color="grey" size="6"><b><a class="btn" href="#"> STATISTICS</a></b></h1></font></center><BR>  
