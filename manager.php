  ...
  <div id="topbar">
     <div id="topnav">
      <ul>
		...
		<li class="active"><a href="manager.php">Statistics</a></li>
        <li ><a href="mfeedback.php">View feedback</a></li>
...
<div class="content">
	...
	<center><h1><font color="grey" size="6"><b><a class="btn" href="#">MANAGER VIEWING STATISTICS</a></b></h1></font></center><BR>  
<td width="606" height="288" colspan="2" valign="top" bgcolor="#393939">
		 <table width="100%" border="1">
        <tr> 
		  <td><div align="center"><font color="#059BD8" size="5">Client Name</font></div></td>
          <td><div align="center"><font color="#059BD8" size="5">Product Name </font></div></td>
          <td><div align="center"><font color="#059BD8" size="5">Weight</font></div></td>
          <td><div align="center"><font color="#059BD8" size="5">Departure</font></div></td>
          <td><div align="center"><font color="#059BD8" size="5">Arrival</font></div></td>
          <td><div align="center"><font color="#059BD8" size="5">Status</font></div></td>
		 <td><div align="center"><font color="#059BD8" size="5">Payment</font></div></td>
		

		<?php 
	  include 'connection.php';
	   $staff=$_SESSION['mname'];
...
echo "<font color='grey' size='6'><b>Welcome </b></h1></font><font color='green' size='6'>".$_SESSION['mname']."</h1></font></html>";
?><br><br>
      <div id="featured">
        <ul>
          <li>
