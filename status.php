  ...
  <div id="topbar">
     <div id="topnav">
      <ul>
        ...
        <li ><a href="order.php">Order Placement</a></li>
        <li class="active"><a href="status.php">Order Status</a></li>
...
<center><h1><font color="grey" size="6"><b><a class="btn" href="#">ORDER STATUS</a></b></h1></font></center><BR>
<td width="606" height="288" colspan="2" valign="top" bgcolor="#393939">
		 <table width="100%" border="2">
        <tr> 
          <td><div align="center"><font color="#059BD8" size="5"><b>PRODUCT NAME </font></div></td>
          <td><div align="center"><font color="#059BD8" size="5"><B>PRODUCT WEIGHT</B></font></div></td>
          <td><div align="center"><font color="#059BD8" size="5"><B>DEPARTURE</B></font></div></td>
          <td><div align="center"><font color="#059BD8" size="5"><B>ARRIVAL</B></font></div></td>
          <td><div align="center"><font color="#059BD8" size="5"><B>STATUS</B></font></div></td>
        </tr>
		<?php 
	  include 'connection.php';
	   $Client=$_SESSION['email'];
	   $rs=mysql_query("select * from `stock` where `EmailId`='$Client'");
	   while($newArray = mysql_fetch_array($rs))
		...
		?>
		 <tr> 
          <td width="25%"><center><font color="black" size="4" face="Courier New, Courier, mono"> 
            <?php echo $Name;?>
            </font></center></td>
          <td width="21%"> <center><font color="black" size="4" face="Courier New, Courier, mono"> 
            <?php echo $Weight;?>
            </font></center></td>
          <td width="15%"> <center><font color="black" size="4" face="Courier New, Courier, mono"> 
            <?php echo $Departur;?>
            </font><center></td>
          <td width="18%"> <center><font color="black" size="4" face="Courier New, Courier, mono"> 
            <?php echo $Arrival;?>
            </font></center></td>
          <td width="18%"><center> <font color="red" size="4"  face="Courier New, Courier, mono"> 
            <?php echo $Status;?>
            </font></center></td>
        </tr>
        <?php
