  ...
  <div id="topbar">
     <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="mfeedback.php">vIEW FEEDBACK</a></li>
...
<center><h1><font color="grey" size="6"><b><a class="btn" href="#">FEED BACKS</a></b></h1></font></center><BR>
<td width="606" height="288" colspan="2" valign="top" bgcolor="#393939">
		 <table width="100%" border="2">
        <tr> 
          <td><div align="center"><font color="#059BD8" size="5"><b>Customer Name</font></div></td>
          <td><div align="center"><font color="#059BD8" size="5"><B>Email</B></font></div></td>
          <td><div align="center"><font color="#059BD8" size="5"><B>Feedback</B></font></div></td>
        </tr>
		<?php 
	  include 'connection.php';
	   $Client=$_SESSION['mname'];
