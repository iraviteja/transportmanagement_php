  ...
  <div id="topbar">
     <div id="topnav">
      <ul>
		...
		<li class="active"><a href="staff.php">Receive Payments</a></li>
        <li ><a href="approve.php">Approve Orders</a></li>
...
<div class="content">
	...
	<center><h1><font color="grey" size="6"><b><a class="btn" href="#">PAYMENT RECEIVEMENT PORTAL</a></b></h1></font></center><BR>  
<td width="606" height="288" colspan="2" valign="top" bgcolor="#393939">
		 <table width="100%" border="1">
        <tr> 
		  <td><div align="center"><font size="3" color="#059BD8">Client Name</font></div></td>
          <td><div align="center"><font size="3" color="#059BD8">Product Name </font></div></td>
          <td><div align="center"><font size="3" color="#059BD8">Weight</font></div></td>
          <td><div align="center"><font size="3" color="#059BD8">Departure</font></div></td>
          <td><div align="center"><font size="3" color="#059BD8">Arrival</font></div></td>
          <td><div align="center"><font size="3" color="#059BD8">Status</font></div></td>
		 <td><div align="center"><font size="2" color="#059BD8">Payment</font></div></td>
		 <td><div align="center"><font size="2" color="#059BD8"></font></div></td>
		...
		<tr> 
          ...
          <td width="18%"> <center><font color="black" face="Courier New, Courier, mono"> 
            ...
            <?php echo $payment;?>
		  			         ...
		  			         <td width="18%"> <center><font color="black" face="Courier New, Courier, mono"> 
           <?php echo"<a href ='paid.php?id=$Name''>Receive Amount</a>" ?>
            </font></center></td>
