...
<!-- ####################################################################################################### -->
	<div class="main">
		<form action="" method="post">
    		<h1><font color="#059BD8"><b><H2>Staff Login</H2></b></h1></font>
  			<div class="inset">
			
	    		 <br><p><label><font color="#059BD8" size="4"><b>ENTER LOGINID</b></font></label></p><br>
   	 			<input type="text" name="uname" placeholder="Staff Login ID" required/>
				</p>
  				<p>
...
session_start();
	...
	function clean($str) {
		...
		if(isset($_POST['submit']))
		{
			$uname=$_POST['uname'];
			$pwd=$_POST['pwd'];
			$result=mysql_query("select * from staff where uname='$uname' and pwd='$pwd'");
